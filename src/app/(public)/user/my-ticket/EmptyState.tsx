...
export const EmptyState = () => (
  <div className="text-center py-16 px-8">
    ...
    <Link href="/movies/now-showing"
     className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-yellow-500 to-amber-500 rounded-full text-black font-bold hover:translate-y-[-2px] hover:shadow-[0_10px_30px_rgba(234,179,8,0.3)] transition-all">
      <Plus size={18} />
      Đặt vé ngay
    </Link>
  </div>
